      ...
      <motion.div
        ...
        <div className="relative w-full overflow-hidden rounded-3xl">
          <Link to={`/post/${post.id}`} className="block w-full z-10">
            ...
            <div className={`w-full h-full aspect-[4/3] relative overflow-hidden rounded-3xl  gap-1
              ${displayImages.length === 1 ? "flex justify-between items-center" : ""}
              ${displayImages.length === 2 ? "flex justify-between items-center" : ""}
              ${displayImages.length === 3 ? "grid grid-cols-3" : ""}
              ${displayImages.length === 4 ? "grid grid-cols-2 grid-rows-2" : ""}
              ${displayImages.length === 5 ? "grid grid-cols-3 grid-rows-2" : ""}
            `}>
