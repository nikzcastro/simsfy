...
export default function PoppupLogin({
  ...
  return !isAuthenticated ? (
    <div
  className={`w-full h-full bg-black/50 backdrop-blur-md z-50 absolute flex justify-center items-center ${
    isModalLogin ? "block" : "hidden"
  }`}
>
  <motion.div
  ...
  >
    ...
    <div className="p-6 space-y-6">
      {/* Discord Login */}
      <button className="w-full h-12 bg-indigo-500 hover:bg-indigo-600 text-white font-semibold rounded-xl transition-colors flex items-center justify-center gap-3">
