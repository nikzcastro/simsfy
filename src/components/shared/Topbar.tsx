...
const languages = [
  ...
  return (
    <>
      ...
      <Link
        to="/"
        className={`w-auto px-4 h-10 bg-gray-200 hover:bg-gray-200 hover:dark:bg-neutral-800/70 ${
          location.pathname === "/" ? "dark:bg-neutral-800 text-black dark:text-white" : " bg-transparent"
  ...
  <div className="relative flex justify-between items-center px-6 py-3">
    ...
    <Link
      ...
      {/* Indicador ativo */}
      <div className={`absolute -top-3 left-0 right-0 h-0.5 bg-gradient-to-r from-lime-400 to-lime-500 rounded-full transition-all duration-300 ${
        window.location.pathname === "/" ? "opacity-100" : "opacity-0"
      }`}></div>
      <div className={`w-10 h-10 flex justify-center items-center transition-colors ${
        window.location.pathname === "/" ? "text-white" : "text-white/80 group-hover:text-white"
      }`}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
    ...
    <Link
      ...
      {/* Indicador ativo */}
      <div className={`absolute -top-3 left-0 right-0 h-0.5 bg-gradient-to-r from-lime-400 to-lime-500 rounded-full transition-all duration-300 ${
        window.location.pathname.includes("/search") ? "opacity-100" : "opacity-0"
      }`}></div>
      <div className={`w-10 h-10 flex justify-center items-center transition-colors ${
        window.location.pathname.includes("/search") ? "text-white" : "text-white/80 group-hover:text-white"
      }`}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
      ...
      <span className={`text-[10px] mt-0.5 ${
        window.location.pathname.includes("/search") ? "text-white" : "text-white/70"
      }`}>Search</span>
    </Link>
    ...
    <Link
      ...
      {/* Indicador ativo */}
      <div className={`absolute -top-3 left-0 right-0 h-0.5 bg-gradient-to-r from-lime-400 to-lime-500 rounded-full transition-all duration-300 ${
        window.location.pathname.includes("/saves") ? "opacity-100" : "opacity-0"
      }`}></div>
      <div className={`w-10 h-10 flex justify-center items-center transition-colors ${
        window.location.pathname.includes("/saves") ? "text-white" : "text-white/80 group-hover:text-white"
      }`}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
      ...
      <span className={`text-[10px] mt-0.5 ${
        window.location.pathname.includes("/saves") ? "text-white" : "text-white/70"
      }`}>Saves</span>
    </Link>
    ...
    {isAuthenticated ? (
      <Link
        ...
        {/* Indicador ativo */}
        <div className={`absolute -top-3 left-0 right-0 h-0.5 bg-gradient-to-r from-lime-400 to-lime-500 rounded-full transition-all duration-300 ${
          window.location.pathname.includes("/profile") ? "opacity-100" : "opacity-0"
        }`}></div>
        <div className={`w-10 h-10 flex justify-center items-center transition-colors ${
          window.location.pathname.includes("/profile") ? "text-white" : "text-white/80 group-hover:text-white"
        }`}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
        ...
        <span className={`text-[10px] mt-0.5 ${
          window.location.pathname.includes("/profile") ? "text-white" : "text-white/70"
        }`}>Profile</span>
      </Link>
    ) : (
      <Link
        ...
        {/* Indicador ativo */}
        <div className={`absolute -top-3 left-0 right-0 h-0.5 bg-gradient-to-r from-lime-400 to-lime-500 rounded-full transition-all duration-300 ${
          window.location.pathname.includes("/login") ? "opacity-100" : "opacity-0"
        }`}></div>
        <div className={`w-10 h-10 flex justify-center items-center transition-colors ${
          window.location.pathname.includes("/login") ? "text-white" : "text-white/80 group-hover:text-white"
        }`}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
        ...
        <span className={`text-[10px] mt-0.5 ${
          window.location.pathname.includes("/login") ? "text-white" : "text-white/70"
        }`}>Login</span>
      </Link>
    )}
