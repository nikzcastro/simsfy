      ...
      >
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-[60%] flex-shrink-0 relative group">
            <div className="w-full aspect-[4/3] relative overflow-hidden rounded-t-3xl lg:rounded-l-3xl lg:rounded-tr-none">
              <img
            ...
            <div className="p-4 border-b border-gray-100 dark:border-neutral-800 flex-shrink-0 bg-gray-50/50 dark:bg-neutral-800/30">
              <div className="w-full flex justify-between items-center">
                <div className="flex items-center gap-2">
                  <button
                    className={`flex justify-center items-center h-11 w-11 ${
                      isLiked(post?.likes, post?.id, Number(user.id))
